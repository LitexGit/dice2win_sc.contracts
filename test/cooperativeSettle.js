...
contract("cooperativeSettle", async accounts => {
  ...
  before(async () => {
    ...
    p1PrivateKey = new Buffer("2fc8c9e1f94711b52b98edab123503519b6a8a982d38d0063857558db4046d89", "hex"); // REPLACE the privatekey with privatekey of accounts in ganache
    p2PrivateKey = new Buffer("d01a9956202e7b447ba7e00fe1b5ca8b3f777288da6c77831342dbd2cb022f8f", "hex"); // REPLACE the privatekey with privatekey of accounts in ganache
  });
